...
<head>
    ...
    <!-- Title -->
    <title> {{ __('admin/auth/login.title') }} </title>
                                ...
                                <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                    <div class="card-sigin">
                                        ...
                                        <div class="main-signup-header">
                                            <h2 class="text-primary">{{ __('admin/auth/login.get_started') }}</h2>
                                            <h5 class="font-weight-normal mb-4">
                                                {{ __('admin/auth/login.waiting') }}
                                            </h5>
                                            <form action="{{ route('admin.auth.login.store') }}" method="POST">
                                                @csrf
                                                <div class="form-group">
                                                    <label>{{ __('admin/auth/login.email') }}</label>
