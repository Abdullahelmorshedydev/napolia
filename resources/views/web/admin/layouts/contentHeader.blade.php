    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="index.html">
                    <img src="{{ asset('admin/assets/img/brand/logo.png') }}" class="logo-1" alt="logo">
                </a>
            </div>
                    ...
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        <a href="#" class="d-flex  nav-item nav-link pr-0 country-flag1" data-toggle="dropdown"
                            ...
                            <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
                                    src="{{ asset('admin/assets/img/flags/' . app()->getLocale() . '_flag.jpg') }}"
                                    alt="img"></span>
                            <div class="my-auto">
                            ...
                            @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                <a hreflang="{{ $localeCode }}"
                                    ...
                                    <span class="avatar  mr-3 align-self-center bg-transparent"><img
                                            src="{{ asset('admin/assets/img/flags/' . $localeCode . '_flag.jpg') }}"
                                            alt="img"></span>
                                    <div class="d-flex">
                        ...
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ asset('admin/assets/img/faces/6.jpg') }}" class=""></div>
