...
class UpdateBlogRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'title_en' => ['required', 'string', Rule::unique('blogs', 'title->en')->ignore($this->blog), 'min:3', 'max:50'],
            'title_ar' => ['required', 'string', Rule::unique('blogs', 'title->ar')->ignore($this->blog), 'min:3', 'max:50'],
