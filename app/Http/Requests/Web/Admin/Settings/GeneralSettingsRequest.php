...
class GeneralSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'site_description_en' => 'required|string|min:3',
            'site_description_ar' => 'required|string|min:3',
            'site_keywords_en' => 'required|string|min:3',
            'site_keywords_ar' => 'required|string|min:3',
    ...
    public function messages()
    {
        return [
            ...
            'site_description_en.required' => __('admin/settings/general/index.required_valid'),
            'site_description_ar.required' => __('admin/settings/general/index.required_valid'),
            'site_description_en.string' => __('admin/settings/general/index.string_valid'),
            'site_description_ar.string' => __('admin/settings/general/index.string_valid'),
            'site_description_en.min' => __('admin/settings/general/index.min_valid'),
            'site_description_ar.min' => __('admin/settings/general/index.min_valid'),
            'site_keywords_en.required' => __('admin/settings/general/index.required_valid'),
            'site_keywords_ar.required' => __('admin/settings/general/index.required_valid'),
            'site_keywords_en.string' => __('admin/settings/general/index.string_valid'),
            'site_keywords_ar.string' => __('admin/settings/general/index.string_valid'),
            'site_keywords_en.min' => __('admin/settings/general/index.min_valid'),
            'site_keywords_ar.min' => __('admin/settings/general/index.min_valid'),
